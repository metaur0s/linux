...
static const char* const cmdNames [CMDS_N] = {
    ...
    [CMD_PATH_SET_LATENCY_MAX] = "CMD_PATH_SET_LATENCY_MAX",
    [CMD_PATH_SET_LATENCY_MIN] = "CMD_PATH_SET_LATENCY_MIN",
    [CMD_PATH_SET_LATENCY_VAR] = "CMD_PATH_SET_LATENCY_VAR",
    ...
    [CMD_PATH_SET_TIMEOUT]     = "CMD_PATH_SET_TIMEOUT",
