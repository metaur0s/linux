...
static const struct {
...
} statsStrs = {  // TODO: MARCAR SE ESTIVER ENVIANDO UM PING ATRASADO
    {
        ...
        __STAT(PSTATS_I_COUNTER_INVALID),
        __STAT(PSTATS_I_COUNTER_NOT_SYN),
        ...
        __STAT(PSTATS_I_PING_LCOUNTER_MISMATCH),
        __STAT(PSTATS_I_PING_RCOUNTER_INVALID),
        __STAT(PSTATS_I_PING_RCOUNTER_REPEATED),
        __STAT(PSTATS_I_PING_RCOUNTER_OLD),
        __STAT(PSTATS_I_PING_RCOUNTER_BAD),
        __STAT(PSTATS_I_PING_RACED),
        __STAT(PSTATS_I_PING_MISSED),
        __STAT(PSTATS_I_PONG_GOOD),
        __STAT(PSTATS_I_PONG_COUNTER_MISMATCH),
