...
static const struct {
...
} statsStrs = {  // TODO: MARCAR SE ESTIVER ENVIANDO UM PING ATRASADO
    {
        ...
        [PSTATS_I_HASH_MISMATCH          ] = "In.HashMismatch",
        [PSTATS_I_WHILE_ACCEPTING        ] = "In.WhileAccepting",
        [PSTATS_I_NOT_PING               ] = "In.NotPing",
        [PSTATS_I_NOT_PONG               ] = "In.NotPong",
        [PSTATS_I_PING_BAD_SIZE          ] = "In.PingBadSize",
        [PSTATS_I_LTIME_MISMATCH         ] = "In.LTimeMismatch",
        [PSTATS_I_RTIME_INVALID          ] = "In.RTimeInvalid",
        [PSTATS_I_RTIME_BACKWARDS        ] = "In.RTimeBackwards",
        [PSTATS_I_ESTABLISHED_SYN        ] = "In.PSTATS_I_ESTABLISHED_SYN",
        [PSTATS_I_NOT_SYN_OR_PING        ] = "In.PSTATS_I_NOT_SYN_OR_PING",
        [PSTATS_I_LTIME_NOT_SYN          ] = "In.PSTATS_I_LTIME_NOT_SYN",
        [PSTATS_I_RTIME_SKEW_UP          ] = "In.PSTATS_I_RTIME_SKEW_UP",
        [PSTATS_I_RTIME_SKEW_DOWN        ] = "In.PSTATS_I_RTIME_SKEW_DOWN",
        ...
        [PSTATS_I_PONG_COUNTER_MISMATCH  ] = "In.Pong.Counter.Mismatch",
