...
#define ITER_X_ADD  SUFFIX_ULL(CONFIG_XGW_ITER_X_ADD)
#define ITER_X_MASK SUFFIX_ULL(CONFIG_XGW_ITER_X_MASK)

#define ITER_KEY_ADD_0 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_0)
#define ITER_KEY_ADD_1 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_1)
#define ITER_KEY_ADD_2 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_2)
#define ITER_KEY_ADD_3 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_3)
#define ITER_KEY_ADD_4 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_4)
#define ITER_KEY_ADD_5 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_5)
#define ITER_KEY_ADD_6 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_6)
#define ITER_KEY_ADD_7 SUFFIX_ULL(CONFIG_XGW_ITER_KEY_ADD_7)
