...
#define I_KEYS_ALL     131
#define I_KEYS_DYNAMIC 128 // NAO TEM QUE CONSIDERAR O OVERFLOW POIS NO KEEPER NAO PRECISA SER ATOMIC
#define I_KEY_SYN      128
#define I_KEY_PING     129
#define I_KEY_PONG     130 // TEM QUE CABER NO PKT->VERSION
...
// 64 -- KEEPER / IN / OUT
    ...
    u32 connsN:24, // O OUT PRECISA DISSO  ((((1 << node->order) * PAGE_SIZE) - offsetof(node_s, conns)) / sizeof(conn_s))
        info:8;
    u32 iCycle; // TODO: CONNS COM __ATOMIC_SEQ_CST
