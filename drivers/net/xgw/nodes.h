...
#define I_KEYS_DYNAMIC 255 // NAO TEM QUE CONSIDERAR O OVERFLOW POIS NO KEEPER NAO PRECISA SER ATOMIC
#define I_KEY_PING     255 // TEM QUE CABER NO PKT->VERSION
