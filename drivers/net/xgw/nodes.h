...
#define I_KEYS_ALL     256 // USA TODOS OS VALORES DO HDR pkt->version E ASSIM NAO PRECISA VERIFICAR
#define I_KEYS_DYNAMIC 254 // NAO TEM QUE CONSIDERAR O OVERFLOW POIS NO KEEPER NAO PRECISA SER ATOMIC
#define I_KEY_PING     254
#define I_KEY_PONG     255 // TEM QUE CABER NO PKT->VERSION
