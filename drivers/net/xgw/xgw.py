...
CMD_ERRS = (
    ...
    'ERR_INVALID_PID',
    'ERR_INVALID_DID',
    'ERR_INVALID_NODE_NAME',
    'ERR_INVALID_PATH_NAME',
    'ERR_INVALID_PHYS',
    'ERR_INVALID_DHCP_IP',
    'ERR_INVALID_PORTS_N',
    'ERR_INVALID_PASSWORD_LEN',
    'ERR_INVALID_TYPE',
    'ERR_INVALID_TOS',
    'ERR_INVALID_TTL',
    'ERR_INVALID_VPROTO',
    ...
    'ERR_INVALID_RTT',
    'ERR_INVALID_RTT_VAR',
    'ERR_INVALID_RTT_RANGE',
    'ERR_PATH_USE_DHCP_NOT_IP',
    'ERR_PATH_USE_DHCP_NOT_IP_4',
    'ERR_PATH_USE_DHCP_NOT_IP_6',
    'ERR_NODE_EXIST',
    'ERR_NODE_DONT_EXIST',
    'ERR_NODE_IS_OFF',
    'ERR_NODE_IS_ON',
    'ERR_NODE_IS_SELF',
    'ERR_NODE_IS_STOPPING',
    'ERR_NODE_NOT_CONFIGURED',
    'ERR_PATH_EXIST',
    'ERR_PATH_DONT_EXIST',
    'ERR_PATH_IS_OFF',
    'ERR_PATH_IS_ON',
    'ERR_PATH_IS_STOPPING',
    'ERR_PATH_NEED_NAME',
    'ERR_PATH_NEED_CLT_SRV',
    'ERR_PATH_NEED_TIMEOUT',
    'ERR_PATH_NEED_RTT_MIN',
    'ERR_PATH_NEED_RTT_MAX',
    'ERR_PATH_NEED_RTT_VAR',
    'ERR_PATH_NEED_PHYS',
    'ERR_PATH_NEED_TOS',
    'ERR_PATH_NEED_TTL',
    'ERR_PATH_NEED_MAC_SRC',
    'ERR_PATH_NEED_MAC_DST',
    'ERR_PATH_NEED_ADDR_SRC',
    'ERR_PATH_NEED_ADDR_DST',
    'ERR_PATH_NEED_PORT_SRC',
    'ERR_PATH_NEED_PORT_DST',
    'ERR_PATH_NEED_VLAN_PROTO',
    'ERR_PATH_NEED_VLAN_ID',
    'ERR_PATH_NEED_PPP_SESSION', # TODO:
    'ERR_PATH_NOT_SERVER',
    'ERR_PATH_NOT_ETH',
    'ERR_PATH_NOT_VLAN',
    'ERR_PATH_NOT_PPP',
    ...
    'ERR_PHYS_NOT_HOOKED',
    'ERR_GWS_FULL',
    'ERR_GWS_NID_NOT_FOUND',
    'ERR_GWS_NID_ALREADY',
    'ERR_ALLOC_CMD',
    'ERR_INVALID_CMD_CODE',
    'ERR_INVALID_CMD_SIZE',
    'ERR_COPY_CMD',
...
def PORTS (ports):
    ports = sorted({int(p) for p in ports.split(',') if p})
    assert 1 <= len(ports) < PORTS_N
    assert all((0 <= p < UDP_PORTS_N) for p in ports)
